package com.feas.api.handler.exception;
 ...
 * AuthenticationException and AccessDeniedException, but will not catch runtime
 * server exception in Filters
 */
@ControllerAdvice
public class ExceptionHandlerAdvisor extends ResponseEntityExceptionHandler implements ExceptionHandlerAdvisorInter {
	...
	private static final Logger local_logger = LoggerFactory.getLogger(ExceptionHandlerAdvisor.class);
