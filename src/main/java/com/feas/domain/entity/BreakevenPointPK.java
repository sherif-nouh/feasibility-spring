...
/**
 * The primary key class for the BREAKEVEN_POINT database table.
 * 
 */
@Embeddable
public class BreakevenPointPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof BreakevenPointPK)) {
			return false;
		}
		BreakevenPointPK castOther = (BreakevenPointPK)other;
		return 
